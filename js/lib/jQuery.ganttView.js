...
(function (jQuery) {
	...
	var Chart = function(div, opts) {
        ...
        // Creates a 3 dimensional array [year][month][day][hour] of every day 
        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                itemDiv.append(jQuery("<div>", {
                    ...
                    "css": { "height": ( cellHeight) + "px" }//data[i].series.length *
                }).append(data[i].name));
        ...
        function addHzHeader(div, dates, cellWidth) {
			...
			for (var y in dates) {
				for (var m in dates[y]) {
                    console.log('Dates count '+dates[y][m].length);
					...
					for (var d in dates[y][m]) {
                        var dw = dates[y][m][d].length * cellWidth;
						daysDiv.append(jQuery("<div>", { 
                            "class": "ganttview-hzheader-day" ,
                            "css": { "width": (dw - 1) + "px" }
                        }).append(dates[y][m][d][0].getDate()));
